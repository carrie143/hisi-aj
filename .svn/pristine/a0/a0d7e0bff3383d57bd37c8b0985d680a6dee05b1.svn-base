...
public class DeviceServiceImpl implements DeviceService {
	...
	@Override
	public List<HisiDevice> getCreamaDevice(String channelId) {
		return hisiDeviceMapper.getCreamaDevice(channelId);
	}
	@Override
	public List<HisiDevice> findCreamaByChannelId(String channelId) {
		return hisiDeviceMapper.findCreamaByChannelId(channelId);
	}
	@Override
	public String selectRoleTypeByIp(String ip) {
		return hisiDeviceMapper.selectRoleTypeByIp(ip);
	}
