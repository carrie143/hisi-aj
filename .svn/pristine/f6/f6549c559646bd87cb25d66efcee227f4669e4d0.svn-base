...
public class UserServiceImpl implements UserService{
	...
	@Override
	public List<HisiUser> findByConditions(String conditions,Integer pageNum,Integer pageSize,String groupName,String roleName,int departmentId) {
		PageHelper.startPage(pageNum,pageSize);
		List<HisiUser> hisiUsers=hisiUserMapper.findByConditions(conditions,groupName,roleName,departmentId);
		return hisiUsers;
	}
	@Override
	...
	@Override
	public List<HisiUser> findUserByGroupName(String groupName) {
		return hisiUserMapper.findUserByGroupName(groupName);
	}
