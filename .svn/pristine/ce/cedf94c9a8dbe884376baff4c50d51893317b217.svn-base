...
public class UnpackVerifyServiceImpl implements UnpackVerifyService {
	...
	public PageInfo<HisiUnpackNecessaryPicReturnInfo> getUnpackNecessary(
		...
		for (HisiUnpackNecessaryPicReturnInfo e : re)
			e.setPicAccess(ftpPic + e.getPicAccess());
	...
	@Override
	public List<String> getScreenShotPhoto(String orderId,int pageNum,int pageSize,String startTime,String endTime) {
		PageHelper.startPage(pageNum, pageSize);
		return hisiScreenshotPicMapper.getScreenShotPhoto(orderId, startTime, endTime);
	}

	@Override
	public List<String> getGoodsPhoto(String orderId,String startTime,String endTime) {
		return hisiUnpackGoodsPicMapper.getGoodsPhoto(orderId, startTime, endTime);
	}
